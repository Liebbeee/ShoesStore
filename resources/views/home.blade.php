...
<div class="container-fluid pt-5">
    <h1 class="section-title position-relative text-uppercase mx-xl-5 mb-4"><span class="bg-secondary pr-3">Kategori Sepatu</span></h1>
            ...
            <a class="text-decoration-none" href="">
                <div class="cat-item d-flex align-items-center mb-4">
                    ...
                    <div class="flex-fill pl-3">
                        ...
                        <small class="text-body">10 Sepatu</small>
                    </div>
                </div>
            </a>
        </div>
...
<div class="container-fluid pt-5 pb-3">
    <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4"><span class="bg-secondary pr-3">Sepatu</span></h2>
